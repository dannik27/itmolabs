...
public class ArraySet2<E> extends AbstractSet<E> implements NavigableSet<E> {
    ...
    public ArraySet2(Collection<E> collection, Comparator<? super E> comparator) {
    ...
    public ArraySet2(Collection<E> collection) {
    ...
    private ArraySet2(List<E> collection, List<E> collectionR, Comparator<? super E> comparator, boolean order) {
    ...
    public NavigableSet<E> descendingSet() {
        return new ArraySet2<E>(this.elementsR, this.elements, Collections.reverseOrder(comparator), naturalOrder);
    }
    ...
    public NavigableSet<E> headSet(E toElement, boolean inclusive) {
        ...
        return new ArraySet2<E>(elements.subList(0, pos + 1), elementsR.subList(size() - pos - 1, size()), this.comparator, naturalOrder);
    }
    ...
    public NavigableSet<E> tailSet(E fromElement, boolean inclusive) {
        ...
        return new ArraySet2<E>(elements.subList(pos, elements.size()), elementsR.subList(0, size() - pos), this.comparator, naturalOrder);
    }
